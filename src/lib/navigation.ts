...
export const quickActions = {
	dispatcher: [
		{ label: 'Create Ride Request', href: '/dispatcher/requests/create', icon: '➕' },
	...
	volunteer: [
		{ label: 'Submit Availability', href: '/volunteer/availability', icon: '⏰' },
		{ label: 'View Opportunities', href: '/volunteer/opportunities', icon: '🌟' }
	]
};
