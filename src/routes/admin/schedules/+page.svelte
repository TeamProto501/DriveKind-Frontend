...
<svelte:head>
  <title>Admin: User Unavailability - DriveKind</title>
</svelte:head>
  ...
  <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
    <div>
      <h1 class="text-3xl font-bold tracking-tight">
        User Unavailability &amp; Time Off
      </h1>
      <p class="text-muted-foreground mt-1">
        Select any user in your organization to view and manage their unavailable times
      </p>
    </div>
  ...
  {#if !data.drivers || data.drivers.length === 0}
    <Card.Root>
      <Card.Header>
        ...
        <Card.Description>
          There are no staff profiles in your organization to manage.
        </Card.Description>
      </Card.Header>
    </Card.Root>
  {:else if !data.selectedUserId}
    <Card.Root>
      <Card.Header>
        ...
        <Card.Description>
          Choose a user from the dropdown above to view their schedule.
        </Card.Description>
      </Card.Header>
    </Card.Root>
  {:else}
    ...
    <Card.Root>
      <Card.Header>
        <Card.Title>User Unavailability Schedule</Card.Title>
        <Card.Description>
          View and manage all unavailable times for this user
        </Card.Description>
      </Card.Header>
      <Card.Content>
        <UnavailabilityTable
      ...
      <Tabs.Content value="one-time">
        <Card.Root>
          <Card.Header>
            ...
            <Card.Description>
              Set this user as unavailable for a specific date
            </Card.Description>
          </Card.Header>
          <Card.Content>
            <form
      ...
      <Tabs.Content value="range">
        <Card.Root>
          <Card.Header>
            ...
            <Card.Description>
              Set this user as unavailable for multiple consecutive days
              (e.g., vacation)
            </Card.Description>
          </Card.Header>
          <Card.Content>
      ...
      <Tabs.Content value="weekly">
        <Card.Root>
          <Card.Header>
            ...
            <Card.Description>
              Set regular weekly patterns for this user (e.g., every Monday
              and Wednesday)
            </Card.Description>
          </Card.Header>
          <Card.Content>
