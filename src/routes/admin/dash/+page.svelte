<script lang="ts">
	...
	const quickActions = [
		{ label: 'Add User', href: '/admin/users/add', icon: Plus, color: 'bg-blue-500' },
		{ label: 'Generate Report', href: '/admin/reports', icon: BarChart3, color: 'bg-green-500' },
		{ label: 'System Settings', href: '/admin/config', icon: Settings, color: 'bg-purple-500' },
		{ label: 'Database Backup', href: '/admin/database', icon: Database, color: 'bg-orange-500' }
	];
				...
				<div class="border-b border-gray-200">
					<div class="flex items-center justify-between px-6 py-4">
						<nav class="flex space-x-8">
							{#each tabs as tab}
								<button
									...
									class="flex items-center space-x-2 py-2 px-1 border-b-2 font-medium text-sm transition-colors duration-200 {selectedTab === tab.id 
						...
						<div class="flex items-center space-x-2">
							<button class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-md transition-colors duration-200" title="Search">
								<Search class="w-4 h-4" />
							</button>
							<button class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-md transition-colors duration-200" title="Filters">
								<Filter class="w-4 h-4" />
							</button>
							<button class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-md transition-colors duration-200" title="Add New">
								<Plus class="w-4 h-4" />
							</button>
							<button class="px-3 py-2 text-sm font-medium bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors duration-200 flex items-center space-x-2">
